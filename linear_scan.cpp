...
//#define ONE     sum += *(((uint64_t *)m_buffer) + i++);
//#define ONE     sum[i] += *(((uint64_t *)m_buffer) + i++);
#define ONE     *(((volatile uint64_t *)m_buffer) + i++);
#define FOUR    ONE ONE ONE ONE
#define SIXTEEN FOUR FOUR FOUR FOUR
#define SIXTYFOUR SIXTEEN SIXTEEN SIXTEEN SIXTEEN
#define FIVEHUNDREDTWELVE SIXTYFOUR SIXTYFOUR SIXTYFOUR SIXTYFOUR SIXTYFOUR SIXTYFOUR SIXTYFOUR SIXTYFOUR
